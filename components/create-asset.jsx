            ...
            <Card>
              ...
              <CardContent className="grid gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="product-price" placeholder="Enter product price" type="number" />
                </div>
                <div className="grid gap-2">
            ...
            <Card>
              ...
              <CardContent className="grid gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="token-quantity" placeholder="Enter token quantity" type="number" />
                </div>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent className="grid gap-4">
                <div className="grid gap-2">
                  ...
                  <Input id="stock-quantity" placeholder="Enter stock quantity" type="number" />
                </div>
                <div className="grid gap-2">
                ...
                <div className="grid gap-2">
                  ...
                  <Textarea id="return-policy" placeholder="Enter return policy details" rows={3} />
                </div>
              </CardContent>
            </Card>
          </div>
